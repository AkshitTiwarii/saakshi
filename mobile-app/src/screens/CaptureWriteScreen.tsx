...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: colors.surface, borderRadius: 16, padding: 14, minHeight: 170, color: colors.ink, textAlignVertical: "top", borderWidth: 1, borderColor: colors.border },
